...
import { FaExternalLinkAlt, FaCode, FaCheckCircle, FaRocket, FaMobileAlt, FaServer, FaCogs } from 'react-icons/fa';
...
const Experience = () => {
    ...
    vi: {
      ...
      projects: [
        ...
        },
        {
          ...
          image: "https://images.unsplash.com/photo-1454165205744-3b78555e5572?q=80&w=1000&auto=format&fit=crop",
  ...
  return (
    <section id="experience" className="section relative bg-[var(--background)] overflow-hidden py-32">
              ...
              <div className="flex-1 space-y-6">
                ...
                {project.specialButtons && (
                  <div className="flex flex-wrap gap-4 pt-8">
                    <a href="https://dichvutot.vn/" target='_blank' className="px-8 py-3 bg-[var(--foreground)] text-[var(--background)] font-bold rounded-xl transition-all hover:scale-105 active:scale-95 flex items-center gap-2">
                      {t.view_live}
